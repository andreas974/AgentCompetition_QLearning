...
public class PeriodDetails extends JPanel {
	...
	public PeriodDetails(Period period) {
		...
		textFieldSequenceNumber = new JTextField(period.getSequenceNumber().toString());
		...
		buttonApplyChanges.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					updatedPeriod.setSequenceNumber(Integer.valueOf(textFieldSequenceNumber.getText()));
