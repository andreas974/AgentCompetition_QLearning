...
public class ContinuousCompetitionQuizRB3_agent extends QuizScreen {
    ...
    public ContinuousCompetitionQuizRB3_agent(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
        ...
        question.addAnswer("Ich stehe ausschließlich mit Firmen im Wettbewerb, die von einem Computeralgorithmus dargestellt werden");
        question.addAnswer("Ich stehe sowohl mit Firmen von menschlichen Experimentteilnehmern als auch von Computeralgorithmus im Wettbewerb", true);
        question.addAnswer("Ich kann keine Aussage darüber treffen, welche Firma von einem Computeralgorithmus dargestellt wird", true);
